...
public class GunController : MonoBehaviour {
    ...
    private void Hit()
    {
            ...
            , out hitInfo, currentGun.range, layerMask))
        {
            ...
            {
                hitInfo.transform.GetComponent<Chicken>().Damage(30, transform.position);
            }
            else if(hitInfo.transform.tag == "Lion")
            {
                hitInfo.transform.GetComponent<Lion>().Damage(30, transform.position);
            }
            else if(hitInfo.transform.tag == "NPC")
            {
                hitInfo.transform.GetComponent<Animal>().Damage(30, transform.position);
            }
